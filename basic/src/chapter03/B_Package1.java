...
public class B_Package1 {
	...
	public static void main(String[] args) {
		...
		// 일반적으로 기본형 데이터 타입의 풀네임에 첫글자를 대문자로 지정하여 사용
		
		// int -> Integer
		int basicInt = 10;
		Integer wrapperInteger = null;
		wrapperInteger = basicInt;
		// wrapper 클래스는 null 을 가질수 있기 때문에 기본형 데이터 타입에 참조형 데이터 타입을 할당할땐 주의해야함
		...
		// parse 메서드 : 문자열을 특정 타입으로 변경(Scanner 의 next 와 비슷)
		...
		System.out.println(Math.round(3.1415 * 100) / 100.0);	// 3.14(정수기 때문에 실수로 나눠주면 실수가 됨)
